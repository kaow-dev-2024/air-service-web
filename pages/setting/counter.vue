...
export default {
  ...
  methods: {
    ...
    async update() {
      let item = await this.$axios
        .put("/counters/" + this.item.counter_id, this.item)
        .then((res) => {
          return true;
        })
        .catch((err) => {
    ...
    async remove(item) {
      ...
      this.$swal
        ...
        .then(async (result) => {
          if (result.value) {
            await this.$axios
              .delete("/counters/" + this.item.counter_id)
              .then((res) => {
                this.alertSuccess();
                this.getCounters();
              })
